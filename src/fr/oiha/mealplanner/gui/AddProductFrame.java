...
public class AddProductFrame extends JFrame {
    ...
    private void setModal(boolean modal) {
        // JFrame doesn't have setModal, but we can achieve similar behavior
        setModalExclusionType(modal ? Dialog.ModalExclusionType.APPLICATION_EXCLUDE :
    ...
    private void initComponents() {
        ...
        // Common units for food products
        String[] units = {"kg", "g", "L", "ml", "unit", "pack"};
        unitComboBox = new JComboBox<>(units);

        // Setup number fields with formatting
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            AddProductFrame dialog = new AddProductFrame(null);
